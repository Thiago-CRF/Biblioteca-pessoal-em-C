...
// funções dos livros
void adicionar_livro(No **head_livros); /* Adiciona um livro, pedindo que digite
...
void listar_livros(const No *head_livros);/* apenas lista os livros, e da um numero de 1
até o ultimo livro
*/
...
void editar_progresso(No *head_livros);/* Lista os livros pra perguntar qual quer editar o progresso
e depois pede pra digitar o novo progresso atualizado*/

void mostrar_livro(const No *head_livros);/*Lista os livros pra perguntar qual quer exibir, e depois
pergunta qual o numero do livro pra exibir e exibe todas as informações do livro escolhido */

void liberar_lista(No **head_livros);/* libera toda a memória da lista, excluindo toda a lista, deixando
